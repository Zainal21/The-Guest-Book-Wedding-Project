...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
				...
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-xs-12">
						...
						<form id="contactForm">
							...
							<div class="col-md-12">
								<div class="form-group">
									<input type="text" placeholder="Masukkan Email Anda" id="email" class="form-control" name="name" required data-error="Masukkan Email Anda">
									<div class="help-block with-errors"></div>
								</div> 
              </div>
              <div class="col-md-12">
								<div class="form-group">
									<input type="text" placeholder="Masukkan Alamat Anda" id="email" class="form-control" name="address" required data-error="Masukkan Alamat Anda">
									<div class="help-block with-errors"></div>
								</div> 
							</div>
							<div class="col-md-12">
								<div class="form-group">
									<select class="custom-select d-block form-control" id="event" required data-error="Please select an item in the list.">
										...
										<option value="1">Semua Acara</option>
										<option value="2">Ijab</option>
										<option value="3">Resepsi</option>
									</select>
									<div class="help-block with-errors"></div>
								</div> 
							</div>
							<div class="col-md-12">
								<div class="form-group"> 
									<textarea class="form-control" id="message" placeholder="Pesan Anda untuk pengantin" rows="8" data-error="Pesan Anda untuk pengantin" required></textarea>
									<div class="help-block with-errors"></div>
								</div>
	...
	<footer class="footer-box">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<p class="footer-company-name">All Rights Reserved. &copy; 2020 Develop By Muhamad Zainal Arifin</a></p>
				</div>
			</div>
		</div>
	</footer>
